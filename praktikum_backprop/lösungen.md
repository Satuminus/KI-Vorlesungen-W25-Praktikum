...
Für Iris (3 Klassen) wird das Label one-hot kodiert $y\in\{0,1\}^K$ mit $K=3$.  
Mit Sigmoid-Ausgängen verwenden wir die Summe binärer Cross-Entropies über alle Outputs:
